(function(a){
    a.fn.webwidget_slideshow_dot=function(p){
        ...
        function init(){
            ...
            for (i = 0; i <= y-1; i++)
            {
                x.find(".thumb_box").append('<span><img src="'+d+'icon04_1.jpg" class="thumb_num" alt="'+i+'" /></span>');
            }            
        ...
        function play(){
            ...
            x.find(".thumb_box").children("span").children("img[class='thumb_num']").attr("src",d+"icon04_1.jpg");
            x.find(".thumb_box").children("span").children("img[class='thumb_num']").eq(w).attr("src",d+"icon04_2.jpg");
