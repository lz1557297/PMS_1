...
<body>
<form id="form1" runat="server" method="post" action="need.do?method=insert">
            ...
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" class="back_main04"><span class="font_bold">新建需求窗口</span></td>
                        </tr>
                    </table></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    ...
                    <tr>
                        <td align="left">需求名称：
                            <input type="text" name="need_title" value="" id="textfield3" class="input" /></td>
                    </tr>

                    <tr>
                        <td align="left">需求详情：
                            <input type="text" name="need_info" value="" id="textfield4" class="input" /></td>
                    </tr>
