...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table02" >
    <tr>
        <td width="180" align="left"><table width="167" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left" class="back_main04"><span class="font_bold">需求信息</span></td>
            </tr>
        </table></td>
        ...
        <td width="27" align="right" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="back_main05">
            <tr>
                <td align="center"><a class="link_white" href="project.do?method=loadAllProject">+ 添加需求</a></td>
            </tr>
        </table></td>
    </tr>
    <tr>
        <td colspan="3">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
                <tr>
                    <td align="center" class="back_main03"><span class="font_bold">需求编号</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">需求名称</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">需求内容</span></td>
                ...
                <c:forEach items="${requestScope.list}" var="need">
                    <tr>
                            <%--<td height="35" align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox2" id="checkbox9" /></td>--%>
                        <td align="center" bgcolor="#FFFFFF">${need.need_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${need.need_title }</td>
                        <td align="center" bgcolor="#FFFFFF">${need.need_info }</td>
                        <td align="center" bgcolor="#FFFFFF">${need.project_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${need.project_name }</td>
                        <td align="center" bgcolor="#FFFFFF">${need.need_set_time }</td>
                        <td align="center" bgcolor="#FFFFFF">${need.need_update_time }</td>
                        <td align="center" bgcolor="#FFFFFF">【<a href='need.do?method=queryOne&need_id=${need.need_id }' class="link_blue">修改</a>】   【<a href='need.do?method=delete&need_id=${need.need_id }' onclick="return confirm('确定要删除当前记录吗?')">删除</a>】</td>
                    </tr>
                </c:forEach>
