...
<body>
<form id="form1" runat="server" method="post" action="need.do?method=update">
    <input type="hidden" name="need_id" value="${param.need_id }">
            ...
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" class="back_main04"><span class="font_bold">需求信息编辑窗口</span></td>
                        </tr>
                    </table></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    ...
                    <tr>
                        <td align="left">需求标题：
                            <input type="text" name="need_title"  id="textfield3" class="input" value="${requestScope.need.need_title }"/></td>
                    </tr>

                    <tr>
                        <td align="left">需求详情：
                            <input type="text" name="need_info"  id="textfield2" class="input" value="${requestScope.need.need_info }"/></td>
                    </tr>
