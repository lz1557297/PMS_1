            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
                ...
                <c:forEach items="${requestScope.list}" var="message">
                    <tr>
                        ...
                        <td align="center" bgcolor="#FFFFFF">【<a href='message.do?method=checkThisOne&message_id=${message.message_id }' class="link_blue">查看</a>】 【<a href='message.do?method=deleteMyReceivedMessage&message_id=${message.message_id }' onclick="return confirm('确定要删除当前记录吗?')">删除</a>】</td>
                    </tr>
                </c:forEach>
