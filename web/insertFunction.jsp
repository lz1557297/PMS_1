...
<body>
<form id="form1" runat="server" method="post" action="function.do?method=insert">
        ...
        <tr>
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    ...
                    <tr>
                        <td align="left">功能名称：
                            <input type="text" name="function_title" value="" id="textfield3" class="input" /></td>
                    </tr>

                    <tr>
                        <td align="left">功能详情：
                            <input type="text" name="function_info" value="" id="textfield4" class="input" /></td>
                    </tr>
