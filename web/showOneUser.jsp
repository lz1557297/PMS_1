...
<body>
<form id="form1" runat="server" method="post" action="user.do?method=update">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" id="main_table03">
  <tr>
    <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="left" class="back_main04"><span class="font_bold">人员编辑窗口</span></td>
          </tr>
        </table></td>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
          <tr>
            <td align="left">用户姓名：            
            <input type="text" name="username"  id="textfield2" class="input" value="${requestScope.user.username }"/></td>
          </tr>
          <tr>
            <td align="left">密码：            
            <input type="text" name="password"  id="textfield3" class="input" value="${requestScope.user.password }"/></td>
          </tr>
          <tr>
            <td align="left">职位id：            
            <input type="text" name="job_id"  id="textfield5" class="input" value="${requestScope.user.job_id }"/></td>
          </tr>
          <tr>
            <td align="left">角色id：            
            <input type="text" name="role_id"  id="textfield4" class="input" value="${requestScope.user.role_id }"/></td>
          </tr>
          <tr>
            <td align="left">用户电话：            
            <input type="text" name="user_tel"  id="textfield9" class="input" value="${requestScope.user.user_tel }"/></td>
          </tr>
          <tr>
            <td align="left">用户email：            
            <input type="text" name="user_email"  id="textfield8" class="input" value="${requestScope.user.user_email }"/></td>
          </tr>
