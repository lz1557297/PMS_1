...
<body>
<form id="form1" runat="server" method="post" action="plan.do?method=write">
            ...
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" class="back_main04"><span class="font_bold">任务编辑窗口</span></td>
                        </tr>
                    </table></td>
                    ...
                    <tr>
                        <td>
                            ...
                            <c:forEach items="${requestScope.list}" var="user">
                                <input type="checkbox" name="ddl" value="${user.user_id}">${user.username}
                            </c:forEach>
