...
<body>
<form id="form1" runat="server" method="post" action="project.do?method=insert">
            ...
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" class="back_main04"><span class="font_bold">新建项目窗口</span></td>
                        </tr>
                    </table></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    ...
                    <tr>
                        <td align="left">项目名称：
                            <input type="text" name="project_name" value="" id="textfield3" class="input" /></td>
                    </tr>
                    ...
                    经理选择:
                    <select name="user_id">
                        <c:forEach items="${requestScope.listx}" var="user">
                    ...
                    <tr>
                        <td align="left">开发人数：
                            <input type="text" name="coder_count" value="" id="textfield5" class="input" /></td>
                    </tr>
                </table>
            </td>
