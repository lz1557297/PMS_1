...
<body>
<form id="form1" runat="server" method="post" action="function.do?method=update">
    <input type="hidden" name="function_id" value="${param.function_id }">
            ...
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" class="back_main04"><span class="font_bold">功能信息编辑窗口</span></td>
                        </tr>
                    </table></td>
                    <td width="50%" align="right"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="back_main05">
                        <tr>
                            <td align="center"><a class="link_white" href="need.do?method=queryAll">+ 返回列表</a></td>
                        </tr>
                    </table></td>
                </tr>
            </table>
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    ...
                    <tr>
                        <td align="left">功能标题：
                            <input type="text" name="function_title"  id="textfield3" class="input" value="${requestScope.function.function_title }"/></td>
                    </tr>

                    <tr>
                        <td align="left">功能详情：
                            <input type="text" name="function_info"  id="textfield2" class="input" value="${requestScope.function.function_info }"/></td>
                    </tr>
