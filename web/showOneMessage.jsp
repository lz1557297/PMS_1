            ...
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="50%"><table width="167" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td align="left" class="back_main04"><span class="font_bold">消息显示窗口</span></td>
                        </tr>
                    </table></td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    <tr>
                        <td align="left">来自：
                            <input type="text" name="client_tel"  id="textfield4" value="${requestScope.message.message_title }"/></td>
                    </tr>
                    <tr>
                        <td align="left">消息标题：
                            <input type="text" name="client_tel"  id="textfield2" value="${requestScope.message.message_title }"/></td>
                    </tr>
                    <tr>
                        <td align="left">消息内容：
                            <input type="text" name="client_tel"  id="textfield3" value="${requestScope.message.message_info }"/></td>
                    </tr>
