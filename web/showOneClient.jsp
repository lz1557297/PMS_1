...
<body>
<form id="form1" runat="server" method="post" action="client.do?method=update">
        ...
        <tr>
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    <tr>
                        <td align="left">客户电话：
                            <input type="text" name="client_tel"  id="textfield2" class="input" value="${requestScope.client.client_tel }"/></td>
                    </tr>
                    <tr>
                        <td align="left">客户地址：
                            <input type="text" name="client_addr"  id="textfield3" class="input" value="${requestScope.client.client_addr }"/></td>
                    </tr>
