...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table02" >
    <tr>
        <td width="180" align="left"><table width="167" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left" class="back_main04"><span class="font_bold">计划信息</span></td>
            </tr>
        </table></td>
        ...
        <td width="27" align="right" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="back_main05">
            <tr>
                <%--<td align="center"><a class="link_white" href="project.do?method=loadAllProjectForPlan">+ 添加计划</a></td>--%>
            </tr>
        </table></td>
    </tr>
    <tr>
        <td colspan="3">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
                <tr>
                    <td align="center" class="back_main03"><span class="font_bold">计划编号</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">计划名称</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">计划内容</span></td>
                    ...
                    <td align="center" class="back_main03"><span class="font_bold">所属功能</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">产品经理</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">工期</span></td>
                ...
                <c:forEach items="${requestScope.list}" var="plan">
                    <tr>
                        ...
                        <td align="center" bgcolor="#FFFFFF">${plan.plan_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${plan.plan_title }</td>
                        <td align="center" bgcolor="#FFFFFF">${plan.plan_info }</td>
                            <%--<td align="center" bgcolor="#FFFFFF">${modd.project.project_id }</td>--%>
                        <td align="center" bgcolor="#FFFFFF">${plan.project.project_name }</td>
                            <%--<td align="center" bgcolor="#FFFFFF">${modd.need_id }</td>--%>
                            <%--<td align="center" bgcolor="#FFFFFF">${plan.need.need_title }</td>--%>
                            <%--<td align="center" bgcolor="#FFFFFF">${plan.modd }</td>--%>
                        <td align="center" bgcolor="#FFFFFF">${plan.function_title }</td>
                        <td align="center" bgcolor="#FFFFFF">${plan.chef_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${plan.deadline }</td>
                        <td align="center" bgcolor="#FFFFFF">${plan.priority }</td>
                        <td align="center" bgcolor="#FFFFFF">已下发</td>
                            <%--<td align="center" bgcolor="#FFFFFF">${mod.need_set_time }</td>--%>
                            <%--<td align="center" bgcolor="#FFFFFF">${mod.need_update_time }</td>--%>
                            <%--<td align="center" bgcolor="#FFFFFF">【<a href='plan.do?method=updateForCheck&plan_id=${plan.plan_id }' class="link_blue">同意</a>】   【<a href='plan.do?method=delete&plan_id=${plan.plan_id }' onclick="return confirm('确定要删除当前记录吗?')">删除</a>】</td>--%>
                    </tr>
                </c:forEach>
