...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table02" >
    <tr>
        <td width="180" align="left"><table width="167" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td align="left" class="back_main04"><span class="font_bold">模块信息</span></td>
            </tr>
        </table></td>
        ...
        <td width="27" align="right" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="back_main05">
            <tr>
                <td align="center"><a class="link_white" href="project.do?method=loadAllProjectForMod">+ 添加模块</a></td>
            </tr>
        </table></td>
    </tr>
    <tr>
        <td colspan="3">
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
                <tr>
                    <td align="center" class="back_main03"><span class="font_bold">模块编号</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">模块名称</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">模块内容</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">所属项目号</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">所属项目</span></td>
                    <td align="center" class="back_main03"><span class="font_bold">所属需求号</span></td>
                ...
                <c:forEach items="${requestScope.list}" var="modd">
                    <tr>
                            <%--<td height="35" align="center" bgcolor="#FFFFFF"><input type="checkbox" name="checkbox2" id="checkbox9" /></td>--%>
                        <td align="center" bgcolor="#FFFFFF">${modd.mod_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.mod_title }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.mod_info }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.project.project_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.project.project_name }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.need_id }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.need_name }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.priority }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.mod_set_time }</td>
                        <td align="center" bgcolor="#FFFFFF">${modd.mod_update_time }</td>
                        <%--<td align="center" bgcolor="#FFFFFF">${mod.need_set_time }</td>--%>
                        <%--<td align="center" bgcolor="#FFFFFF">${mod.need_update_time }</td>--%>
                        <td align="center" bgcolor="#FFFFFF">【<a href='mod.do?method=queryOne&mod_id=${modd.mod_id }' class="link_blue">修改</a>】   【<a href='mod.do?method=delete&mod_id=${modd.mod_id }' onclick="return confirm('确定要删除当前记录吗?')">删除</a>】</td>
                    </tr>
                </c:forEach>
