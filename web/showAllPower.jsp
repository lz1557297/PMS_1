...
<body>
<form  id="form1"  name="f1" action="power.do?method=updatePower" method="post">
    <input type="hidden" value="${param.role_id }" name="role_id"/>
        ...
        <tr>
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    ...
                    <tr>
                        <td align="left">
                            <c:forEach items="${requestScope.list}" var="power">
                                <script>
                                    var b = 'c';
                                </script>
                                <c:forEach items="${requestScope.list1}" var="power1">
                                    <c:if test="${power.power_id == power1.power_id }">
                                        <script>
                                            b = 'true';
                                        </script>
                                    </c:if>
                                ...
                                <script type="text/javascript">
                                    powerId.add(${power.power_id},${power.upper_id},'${power.power_name}',b,${power.power_id},'pids');
                                </script>
                            </c:forEach>
                            <script type="text/javascript">
