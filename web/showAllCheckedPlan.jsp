            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
                ...
                <c:forEach items="${requestScope.list}" var="plan">
                    <tr>
                        ...
                        <td align="center" bgcolor="#FFFFFF">【<a href='plan.do?method=queryCoder&plan_id=${plan.plan_id }' class="link_blue">下发任务</a>】   【<a href='plan.do?method=delete&plan_id=${plan.plan_id }' onclick="return confirm('确定要删除当前记录吗?')">删除</a>】</td>
                    </tr>
                </c:forEach>
