...
<body>
<form id="form1" runat="server" method="post" action="role.do?method=update">
    <input type="hidden" name="roid" value="${param.roid }">
        ...
        <tr>
            <td width="570" align="left"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" bgcolor="#FFFFFF" class="border03">
                    <tr>
                        <td align="left">角色名称：
                            <input type="text" name="roname"  id="textfield2" class="input" value="${requestScope.role.roname }"/></td>
                    </tr>
                </table>
            </td>
