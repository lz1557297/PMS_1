...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_table02" >
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#dedede">
                ...
                <c:forEach items="${requestScope.list}" var="message">
                    <tr>
                        ...
                        <td align="center" bgcolor="#FFFFFF">【<a href='message.do?method=checkThisOne&message_id=${message.message_id }' class="link_blue">查看</a>】</td>
                    </tr>
                </c:forEach>
    ...
    <tr>
        ...
        <%
            int curPage = (Integer)request.getAttribute("curPagexxxxx");
        %>
        <td colspan="9">
            <a href="message.do?method=queryMessageByPage&curPage=<%=curPage-1 %>">上一页</a>

            <a href="message.do?method=queryMessageByPage&curPage=<%=curPage+1 %>">下一页</a>
        </td>
    </tr>
    <tr>
